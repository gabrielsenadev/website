...
export function Welcome() {
  return (
    <main>
      <h1 className='uppercase tracking-[0.29em] font-bold text-2xl'>Hi! Welcome to my space!</h1>
      ...
      <h1 className='lowercase tracking-[0.29em] font-bold text-1xl mt-5'>for now, that is it!</h1>
    </main>
  )
}
